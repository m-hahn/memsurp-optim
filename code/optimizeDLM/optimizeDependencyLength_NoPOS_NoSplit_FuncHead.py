...
def orderSentence(sentence, dhLogits, printThings):
   ...
   for line in sentence:
      ...
      if line["coarse_dep"].startswith("punct"):
         continue
      key = (line["coarse_dep"]) if line["coarse_dep"] != "root" else stoi_deps["root"]
...
relevantPath = "/u/scr/mhahn/deps/DLM_MEMORY_OPTIMIZED/locality_optimized_dlm/manual_output_funchead_fine_depl_nopos_funchead/"
  ...
  while True:
    ...
    for partition in partitions:
       ...
       if counter % 10000 == 0:
          ...
          print "Saving"
          with open(TARGET_DIR+"/manual_output_funchead_fine_depl_nopos_funchead/"+args.language+"_"+__file__+"_model_"+str(myID)+".tsv", "w") as outFile:
