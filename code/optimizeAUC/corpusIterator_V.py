...
def readUDCorpus(language, partition, ignoreCorporaWithoutWords=True, errorWhenEmpty=True):
      ...
      for name in files:
        ...
        if "Chinese-CFL" in name or "English-ESL" in name or "Hindi_English" in name or "French-FQB" in name or "Latin-ITTB" in name or "Latin-LLCT" in name or "English-Pronouns" in name or "English-GUMReddit" in name or "Turkish_German" in name or "Chinese-GSDSimp" in name:
           print >> sys.stderr, ("Skipping "+name)
           continue
